...
2. Read every source file end-to-end (`App.jsx` 1304 lines, `mobile.jsx`, `HeroVisual.jsx`,
   `FloatingCard.jsx`, `MediTrackAIAuthIllustration.jsx`, `MediTrackAIPhoneSection.jsx`,
...
> 2. `MediTrackAIAuthIllustration.jsx` and `MediTrackAIPhoneSection.jsx` live at **`Landingpage/` root**,
>    **not** under `src/`. `App.jsx` imports the former as `../MediTrackAIAuthIllustration`.
> 3. `MediTrackAIPhoneSection.jsx` and `FloatingCard.jsx` are **not imported anywhere** —
...
| `src/App.jsx`                                        | 64,507    | 1304  | **P**   | The landing page. Single default export `MediTrackAILanding`. Sections: helpers/mascots (49–268), dashboard-mockup components (270–538), `MediTrackAILanding` main (540–1304): `#hero-setup` styles 623–692, **Nav** 694–747, **Hero** 749–876, **How It Works** 878–955, **Features × 3** 957–1070, **Trust** 1072–1083, **Final CTA** 1085–1148, **Footer** 1150–1219, **floating AI chat** 1221–1297. Hand-rolled `#auth` hash view-switch (544–575, 1299–1301) renders `MediTrackAIAuthIllustration` — replaced by real `/login`+`/register` routes in Next. |
...
| `public/imagessss/login_page.jpeg`                   | 349,470   | —     | **P**   | Referenced: `MediTrackAIAuthIllustration.jsx:187` (auth left panel image).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
src/main.jsx ──> src/App.jsx ──> ./components/HeroVisual.jsx ──> ../mobile.jsx
                             └─> ../MediTrackAIAuthIllustration.jsx   (root, "__"/"__")
src/components/FloatingCard.jsx   (imported by NOBODY — recipe only)
MediTrackAIPhoneSection.jsx          (imported by NOBODY — composition reference only)
```

- Runtime code of the landing page = `App.jsx` + `HeroVisual.jsx` + `mobile.jsx` +
  `MediTrackAIAuthIllustration.jsx` (when `#auth`).
- `FloatingCard.jsx` and `MediTrackAIPhoneSection.jsx` are isolated design artifacts; they are
...
| `/imagessss/login_page.jpeg`                                                                     | `MediTrackAIAuthIllustration.jsx:187` | port → `public/auth/login-page.jpeg` (rename; `imagessss` is a Stitch typo dir) |
...
| 1221–1297     | **Floating AI chat** (FAB 1288–1296; panel header gradient `#10b981→#059669` + `Bot` + "MediTrack AI" + "● Online · Replies instantly" `rgba(255,255,255,0.8)` 1233–1240; bot bubble `#f0fdf4` 1247). **Decorative** — becomes a link to `/help`. | `AiChatFab.tsx` (decorative → `/help`)                                             |
...
### `MediTrackAIPhoneSection.jsx` — phone mockup part 2 (composition reference)
...
### `MediTrackAIAuthIllustration.jsx` — auth screen (port for `/login`·`/register`)
...
| `--color-primary-dark`   | `#059669`                                                     | ✅                   | cta gradient end `App.jsx:636`; auth hover `MediTrackAIAuthIllustration.jsx:129`; final CTA `App.jsx:1088`                            |
| `--color-primary-tint`   | `#d1fae5`                                                     | ✅                   | folder icon chip `App.jsx:381`; check chips `App.jsx:995`; row icon `mobile.jsx:138`                                                  |
| `--color-primary-tint-2` | `#a7f3d0`                                                     | ✅                   | `mvp-fc-ico` gradient end `MediTrackAIPhoneSection.jsx:108`                                                                           |
| `--color-primary-soft`   | `#f0fdf4`                                                     | ✅                   | hero gradient start `App.jsx:755`; bot bubble `App.jsx:1247`; `0 8px 4px` nurse card `App.jsx:149`                                    |
| `--color-primary-ring`   | `rgba(16,185,129,0.12)`                                       | ✅                   | auth input focus shadow `MediTrackAIAuthIllustration.jsx:38`                                                                          |
...
| `--ink-800`              | `#1e293b`                                                     | ✅                   | labels `MediTrackAIAuthIllustration.jsx:249`; mascot strokes `App.jsx:61`                                                             |
...
| `--ink-400`              | `#94a3b8`                                                     | ✅                   | testimonial role `App.jsx:324`; chip time `HeroVisual.jsx:79`; eye icon `MediTrackAIAuthIllustration.jsx:4`                           |
| `--phone-muted`          | `#9ab5ad`                                                     | ✅                   | `mvp-sc-s`/`mvp-sc-d` `mobile.jsx:122–123`; `MediTrackAIPhoneSection.jsx:89–90`                                                       |
| `--phone-ink`            | `#0d1f1a`                                                     | ✅                   | phone inner frame `mobile.jsx:109`; label/title `mobile.jsx:117,121`                                                                  |
| `--border`               | `#e2e8f0`                                                     | ✅                   | nav border-bottom/ghost border `App.jsx:646,700`; testimonial border `App.jsx:308`; input border `MediTrackAIAuthIllustration.jsx:30` |
| `--border-strong`        | `#cbd5e1`                                                     | ✅                   | Google hover `MediTrackAIAuthIllustration.jsx:157`; skeleton bars `App.jsx:424`                                                       |
| `--bg`                   | `#f8fafc`                                                     | ✅                   | body bg `App.jsx:626`; How-It-Works section bg `App.jsx:879`; auth left `MediTrackAIAuthIllustration.jsx:64`                          |
| `--bg-card`              | `#ffffff`                                                     | ✅                   | all cards (testimonial `App.jsx:306`, how-it-works `App.jsx:928`)                                                                     |
| `--bg-input`             | `#f8fafc`                                                     | ✅                   | input resting `MediTrackAIAuthIllustration.jsx:31`                                                                                    |
...
| Phone mockup face | DM Sans 400–800                                                | `mobile.jsx:44`, `MediTrackAIPhoneSection.jsx:5`                                                                                                             |
...
| Auth headline     | `clamp(40px,4vw,56px)` / 900 / ls `-0.03em`                    | `MediTrackAIAuthIllustration.jsx:232`                                                                                                                        |
| Field label       | 14 / 700 / `#1e293b`                                           | `MediTrackAIAuthIllustration.jsx:249`                                                                                                                        |
| Field text        | 15 / 500                                                       | `MediTrackAIAuthIllustration.jsx:33–35`                                                                                                                      |
...
| IconButton 44 circle back button                               | `.back-btn` `MediTrackAIAuthIllustration.jsx:159–178`                                                    |
| Auth/form primary button (radius 14, full width, lift+shadow)  | `.btn-primary` `MediTrackAIAuthIllustration.jsx:111–135`                                                 |
| Inputs                                                         | `iStyle` `MediTrackAIAuthIllustration.jsx:26–40`                                                         |
| Google button                                                  | `.btn-google` `MediTrackAIAuthIllustration.jsx:137–157`                                                  |
| Checkbox (18 px, accent emerald)                               | `MediTrackAIAuthIllustration.jsx:287`                                                                    |
...
| Glass cards                                                    | `FloatingCard.jsx:16–20`; `MediTrackAIPhoneSection.jsx:96–105`; `HeroVisual.jsx:47–61`                   |
| Chip/icon tiles (tint bg + colored icon)                       | `HeroVisual.jsx:63–73` `${color}18`; `mobile.jsx:120`; `App.jsx:381`                                     |
| Snooze pill                                                    | `.mvp-snooze` `MediTrackAIPhoneSection.jsx:115`                                                          |
...
2. **Glass card radii differ per component**: Stitch uses 16 px (`rounded-2xl`) in
   `FloatingCard.jsx`/`FeatureMedicalRecords`, 18 px in `MediTrackAIPhoneSection` `.mvp-fc`, 22 px
...
5. **Wordmark sizes**: nav 20 px/900 (`App.jsx:717–719`), footer 19 px/900, auth 26 px/800
   (`MediTrackAIAuthIllustration.jsx:225–227`). §5.1 "~20 px / weight 900" = nav/footer; auth uses
   800 weight at 26 px.
...
7. **Import of lucide `HeartPulse` is `stroke` style; the logo baseline is `#10b981→#06b6d4`
   at 135°** with white text/icons (nav `App.jsx:711`, auth `MediTrackAIAuthIllustration.jsx:217`).
...
| `≥ 900`    | Auth left image panel shown (`flex:1.1`, `#f8fafc`); hidden below             | `MediTrackAIAuthIllustration.jsx:59–67` |
...
| Auth split screen                                  | `MediTrackAIAuthIllustration.jsx`                               | `/login`, `/register`                                                      | ✅ port        |
| Phone feed rows / SectionLabels                    | `mobile.jsx:129–234`                                            | `/schedule` (Upcoming rows), `/history` (Recent Reports), `/notifications` | ✅ motif reuse |
| Floating "AI Insight" glass card                   | `MediTrackAIPhoneSection.jsx:196–208`                           | `/dashboard`, `/insights`                                                  | ✅ motif       |
| "Medicine reminder … Snooze" card                  | `MediTrackAIPhoneSection.jsx:224–254`                           | DoseCard Take/Snooze/Skip everywhere                                       | ✅ motif       |
...
| "Report Upload"/OCR + "Vitals Tracked"/visit chips | `MediTrackAIPhoneSection.jsx:209–222`, `HeroVisual.jsx:104–130` | **none** (non-goals §3) — retain visual language only                      | ✅ documented  |
...
| `MediTrackAIPhoneSection.jsx` (c1–c4 196–254, `.mvp-*` CSS 4–121)             | `features/landing/PhoneMockupFloats.tsx` (composition)                                                  |
...
| `MediTrackAIAuthIllustration.jsx`                                             | `features/auth/AuthShell.tsx` (+ `LoginForm`/`RegisterForm`)                                            |
| `src/App.jsx:709–719` + `MediTrackAIAuthIllustration.jsx:214–228`             | `components/brand/Logo.tsx`, `Wordmark.tsx`                                                             |
...
- ✅ Import-graph fact: `FloatingCard.jsx` + `MediTrackAIPhoneSection.jsx` unused at runtime.
