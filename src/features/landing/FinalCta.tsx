...
export default function FinalCta() {
  ...
  return (
    <section id="contact" className="overflow-hidden bg-white" style={{ padding: "20px 4% 100px" }}>
      ...
      >
        <div
          className="bg-white/10 absolute right-[-70px] top-[-70px] h-[200px] w-[200px] rounded-full"
          aria-hidden
        />
        <div
          className="bg-white/10 absolute bottom-[-80px] left-[-40px] h-[160px] w-[160px] rounded-full"
          aria-hidden
        />
        ...
        <p className="text-white/85" style={{ fontSize: 15, fontWeight: 600, marginBottom: 26 }}>
          Ready to put your medical life in one place? 💚 Sign up today — free forever, no credit
          card.
        </p>
        ...
        >
          <input
            type="email"
            name="vaultEmail"
            placeholder={`Enter your email — ${BRAND.name} inbox`}
            aria-label={`Email for ${BRAND.name}`}
          ...
          <a
            className="cta-white"
            href="/register"
            style={{ padding: "17px 38px", fontSize: 15.5, width: "auto" }}
          >
            Get Started
          </a>
        </div>
        ...
        <div className="text-white/65 mt-4 text-[12.5px]">
          Join 1,00,000+ patients who trust {BRAND.name} ·{" "}
          <span className="underline underline-offset-2">Privacy-first</span>
        </div>
      </div>
    </section>
  );
