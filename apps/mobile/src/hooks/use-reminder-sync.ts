...
export function useReminderSync(): {
  ...
  // what effects are for. `set-state-in-effect` is switched off for this file in
  // `eslint.config.mjs`: the rule fires because `sync` eventually sets state, but those calls all
